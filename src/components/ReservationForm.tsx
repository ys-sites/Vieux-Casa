...
import { Calendar, Clock, Users, User, Mail, Phone, MessageSquare, GlassWater, CheckCircle, Loader } from 'lucide-react';
...
export default function ReservationForm({ lang }: ReservationFormProps) {
  ...
  const handleSubmit = () => {
    setStatus('loading');
    const fallback = setTimeout(() => { setStatus('success'); reset(); }, 8000);
  ...
  if (status === 'success') {
    return (
      <div className="bg-sand/80 backdrop-blur-md p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-mediterranean/5 max-w-2xl mx-auto text-center">
        ...
        <p className="text-mediterranean/60 mb-2">
          {lang === 'fr'
        ...
        <p className="text-mediterranean/40 text-sm mb-8">
          {lang === 'fr'
            ? 'Si c\'est votre première soumission, vérifiez vos courriels pour un lien de confirmation FormSubmit.'
            : 'If this is your first submission, check restoredinmtl@gmail.com for a FormSubmit confirmation email and click the link.'}
        </p>
        <button
  ...
  return (
    <>
      <iframe ref={iframeRef} name="fs-hidden" title="hidden" style={{ display: 'none' }} />
      <div className="bg-sand/80 backdrop-blur-md p-8 md:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-mediterranean/5 max-w-2xl mx-auto text-center relative z-10">
        <form
          action="https://formsubmit.co/restoredinmtl@gmail.com"
          method="POST"
          target="fs-hidden"
        ...
        >
          ...
          <input type="hidden" name="_subject" value={`New Event Reservation – ${formData.name} · ${formData.eventType}`} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                type="text" name="Full Name" required value={formData.name} onChange={set('name')}
            ...
            <div className="space-y-2">
              ...
              <input
                type="tel" name="Phone Number" required value={formData.phone} onChange={set('phone')}
                className="w-full bg-sand-dark border-none rounded-xl px-4 py-3 text-mediterranean focus:ring-2 focus:ring-gold transition-shadow placeholder:text-mediterranean/30"
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <input
                type="email" name="Email Address" required value={formData.email} onChange={set('email')}
                className="w-full bg-sand-dark border-none rounded-xl px-4 py-3 text-mediterranean focus:ring-2 focus:ring-gold transition-shadow placeholder:text-mediterranean/30"
            ...
            <div className="space-y-2">
              ...
              <input
                type="date" name="Date" required min={minDate} value={formData.date} onChange={set('date')}
            ...
            <div className="space-y-2">
              ...
              <select
                name="Time" required value={formData.time} onChange={set('time')}
            ...
            <div className="space-y-2">
              ...
              <input
                type="number" name="Number of Guests" required min={40} max={500} value={formData.guests} onChange={set('guests')}
                className="w-full bg-sand-dark border-none rounded-xl px-4 py-3 text-mediterranean focus:ring-2 focus:ring-gold transition-shadow"
              />
              <p className="text-[10px] text-mediterranean/50 mt-1">
            ...
            <div className="space-y-2">
              ...
              <select
                name="Event Type" required value={formData.eventType} onChange={set('eventType')}
                className="w-full bg-sand-dark border-none rounded-xl px-4 py-3 text-mediterranean focus:ring-2 focus:ring-gold transition-shadow appearance-none"
              >
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <textarea
                name="Special Requests" value={formData.requests} onChange={set('requests')} rows={2}
            ...
            <input type="hidden" name="Language" value={lang === 'fr' ? 'French' : 'English'} />
          </div>
